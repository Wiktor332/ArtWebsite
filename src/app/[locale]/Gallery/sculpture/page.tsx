        ...
        <div className="relative flex justify-center mt-28 mb-10 p-4">
          <ul className="flex flex-wrap justify-center gap-20">
            ...
            <li>
              ...
              <p className="font-semibold italic mt-[2px]">Kokon III, 40x40, 2020</p>
            </li>

            <li>
              <Image src="/images/sculpture/Katarzyna Kuta, Kokon II, rzeźba, 50x35, 2020r.,cena 500zł.JPG" alt="photo" width={750} height={550} />
              <p className="font-semibold italic mt-[2px]">Kokon II, 50x35, 2020</p>
            </li>
            ...
            <li>
              ...
              <p className="font-semibold italic mt-[2px]">Kokon - tryptyk, (84x50, 40x40, 50x35), 2020</p>
            </li>
            ...
            <li>
              ...
              <p className="font-semibold italic mt-[2px]">Wzorzec geograficzny, 58x52x30, 2019</p>
            </li>
            
            <li>
              <Image src="/images/sculpture/Katarzyna Kuta,Kokon I, rzeźba, wym. 84x50, 2020r.,1500zł.JPG" alt="photo" width={750} height={550} />
              <p className="font-semibold italic mt-[2px]">Kokon I, 84x50, 2020</p>
            </li>
